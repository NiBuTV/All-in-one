...
<link rel="shortcut icon" type="image/x-icon" href="https://i.ibb.co/SwZV542/20220526-172914.png">
...
.loading {
    ...
    .plyr__video-wrapper::before {
        ...
        height: 35px;
        width: 35px;
        background: url('https://i.ibb.co/7YJgNqm/20220526-173121.png') no-repeat;
    ...
    .plyr__video-wrapper::after {
        ...
        height: 35px;
        width: 35px;
        background: url('https://i.ibb.co/SwZV542/20220526-172914.png') no-repeat;
        background-size: 35px auto, auto;
    }
